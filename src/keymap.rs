...
pub const ACTIONS: &[(&str, Action, &str)] = &[
    ...
    ("follow", Action::Follow, "jump to end/tail"),
    ("confirm", Action::Confirm, "run stage / open item"),
    ...
    ("takeover", Action::Takeover, "take over in claude"),
    ("nvim-open", Action::NvimOpen, "open in running nvim"),
    (
        "nvim-quickfix",
        Action::NvimQuickfix,
        "findings → nvim quickfix",
    ),
    ...
    (
        ...
        "apply queued answers",
    ),
    ("triage-all", Action::TriageAll, "apply recommended triage"),
    (
        "queue-all-code",
        Action::QueueAllCode,
        "queue all code fixes",
    ),
