...
Everything that shipped per version (v0.2 → v0.13 · panel focus), the deferred list, the design rationale behind each item, and the non-goals live in [ROADMAP.md][roadmap-url].
