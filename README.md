...
budget_architect_usd = 3.0    # per architecture-map survey (ritual architect)
redaction = true
notifications = true
...
[architect]                   # the generated architecture map
enabled = true                # false silences the missing/stale nudges
auto_refresh = true           # refresh the map when `ritual complete` reaches done
...
[version-shield]: https://img.shields.io/badge/version-0.13.0-9d7cd8?style=for-the-badge
